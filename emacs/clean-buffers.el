...
;;
(defvar clean-buffer-list '("\\*Completions\\*" "sent \\(message\\|reply\\|mail\\)" "\\*MailCrypt" "\\*Man" "\\*Apropos" "\\*.*output\\*" "\\*TeX background\\*")
  "List of regexs of buffers to clean up")
(defvar clean-buffer-extended-list '("\\*.*[Cc]ompil" "\\*.*[Dd]irectory" "\\*.*[Hh]elp" "\\*.*[Ll]og" 
				     "\\*.*Presentation\\*" "\\*Buffer List\\*")
